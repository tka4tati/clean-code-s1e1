...
var incompleteTaskHolder=document.getElementsByClassName("do-list")[0];//ul of .do-list
var completedTasksHolder=document.getElementsByClassName("done-list")[0];//done-list
...
var createNewTaskElement=function(taskString){
    ...
    editInput.type="text";
    editInput.className="list__task task";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("do-list__item_edit");
    //If class of the parent is .do-list__item_edit
    if(containsClass){

        //switch to .do-list__item_edit
    ...
    //toggle .do-list__item_edit on the parent.
    listItem.classList.toggle("do-list__item_edit");
};
